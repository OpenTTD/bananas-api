...
def main():
    ...
    github_app_id = os.getenv("BANANAS_API_GITHUB_ASKPASS_APP_ID")
    github_app_key = os.getenv("BANANAS_API_GITHUB_ASKPASS_APP_KEY")
    github_url = os.getenv("BANANAS_API_GITHUB_ASKPASS_URL")
    ...
    gh = github3.GitHub()
    gh.session.base_url = os.getenv("BANANAS_API_GITHUB_ASKPASS_API_URL")
